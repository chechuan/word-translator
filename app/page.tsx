  ...
  return <main>
    ...
    <div className="page-shell" id="top">
      <section className="translator-card" aria-label="英文翻译输入区">
        {isLoading && <svg className="translation-progress" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true"><rect x="0.12" y="0.18" width="99.76" height="99.64" rx="1.6" ry="5.5" pathLength="100" vectorEffect="non-scaling-stroke" /></svg>}
