  ...
  return <main>
    ...
    <div className="page-shell" id="top">
      <section className="translator-card" aria-label="英文翻译输入区">
        {isLoading && <svg className="translation-progress" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true"><rect x="0.8" y="0.8" width="98.4" height="98.4" rx="3.8" pathLength="100" /></svg>}
